...
| `TODO.md` | 待办事项 | 计划中的功能、待修复的问题、改进建议 | ⭐⭐⭐ |
| `CHANGELOG.md` | 变更日志 | 记录所有版本的重要变更 | ⭐⭐⭐ |
| `ROADMAP.md` | 路线图 | 项目发展规划、里程碑、时间线 | ⭐⭐ |
...
- [x] 功能：基础 CRUD 接口实现 (2024-01-15)
- [x] 修复：修复了 #123 号问题 (2024-01-10)
```
