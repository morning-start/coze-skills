...
| [guides/document/consistency-check-guide.md](references/guides/document/consistency-check-guide.md)           | 一致性检查指南 | 文档质量检查时           |
...
| [guides/project-types/README.md](references/guides/project-types/README.md)                                   | 项目类型指南   | 按项目类型生成文档时     |
