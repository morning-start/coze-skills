...
phase: publishing
description: 发布执行器，执行 git commit 和 tag 操作完成版本发布
tags: [skill-factory, publishing, release, git, tag]
---
...
每次发布应在 SKILL.md 的版本历史中追加：

```markdown
| v10.0.0 | 2026-05-01 | 大版本升级：整合 skill-lifecycle，新增 8 个子技能 |
