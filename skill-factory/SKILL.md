...
**结论**: skill-factory v10 是 skill-lifecycle 的超集，skill-lifecycle 可视为历史版本归档。
...
| 版本 | 日期 | 变更说明 |
|------|------|----------|
| **v10.0.0** | 2026-05-01 | 大版本升级：整合 skill-lifecycle，新增加工/发布/销毁三阶段，共 13 个子技能 |
| v9.2.0 | 2026-04-30 | 修复 Mermaid 渲染问题 |
| v9.0.0 | 2026-04-30 | 新增 researcher 阶段 |
| v7.0.0 | 2026-04-30 | 引入四维分类体系 |
